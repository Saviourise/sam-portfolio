  ...
  return (
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route path="about" element={<div style={{ padding: '80px 60px', fontFamily: 'var(--font-heading)', fontSize: '48px', fontWeight: 900, textTransform: 'uppercase' }}>About — Coming Soon</div>} />
