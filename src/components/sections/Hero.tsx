...
export default function Hero() {
  return (
    <>
      {/* ── Desktop ── */}
      <section className="hidden md:flex justify-center w-full py-20">
        <div className="flex w-full max-w-[1400px]">

          {/* Left */}
          <div className="flex-1 flex flex-col justify-center h-[calc(100vh-64px)] max-h-180 pt-20 pb-20 px-10">
